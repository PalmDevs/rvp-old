...
*  `autorepeat-by-default` patch ([#148](https://github.com/PalmDevs/rvp/issues/148)) ([fe628ba](https://github.com/PalmDevs/rvp/commit/fe628ba909d89ea0bf3d95fe94ca78ef819677da))
* `auto-captions` patch switch description ([#488](https://github.com/PalmDevs/rvp/issues/488)) ([57824fb](https://github.com/PalmDevs/rvp/commit/57824fb16c56889d8f18299e9bab2563bb13e5c2))
* `codecs-unlock` patch and update Music patches to `5.14.53` ([2437d30](https://github.com/PalmDevs/rvp/commit/2437d3070f6a630d353619f642cefebd47abee20))
* `create-button-signature` ([a173f6e](https://github.com/PalmDevs/rvp/commit/a173f6e5a7e65943657e2072e8a72a4a680e5277))
* `custom-branding` patch failing to get resources ([efb6d4c](https://github.com/PalmDevs/rvp/commit/efb6d4c2be515185fc9bd29c40ce202f0d684cee))
* `default-video-quality` patch crashing ([#227](https://github.com/PalmDevs/rvp/issues/227)) ([379327a](https://github.com/PalmDevs/rvp/commit/379327a6b2325ef93c7107472343dd9fd85a0f56))
* `disable-create-button` not working with prebuilt jar file ([#55](https://github.com/PalmDevs/rvp/issues/55)) ([78be64a](https://github.com/PalmDevs/rvp/commit/78be64accc2023281c0c376849cdb0213622dc5c))
* `enable-seekbar-tapping` patch ([52fd726](https://github.com/PalmDevs/rvp/commit/52fd726d9b0d2efbd0f9742fc84ad01ccdcff168))
* `exclusive-audio-playback` patch ([#153](https://github.com/PalmDevs/rvp/issues/153)) ([9beff95](https://github.com/PalmDevs/rvp/commit/9beff9567f1586e5c58690c1f1d2f7f204025ab7))
* `hrd-auto-brightness` ([#152](https://github.com/PalmDevs/rvp/issues/152)) ([5f2e9ba](https://github.com/PalmDevs/rvp/commit/5f2e9ba30b7432be04bdc9f9f7ec7ac75fdc4b34))
* `Index` in wrong package ([2f9360f](https://github.com/PalmDevs/rvp/commit/2f9360f57cc8415564534fbbd8bd5e2a83a1b629))
* `minimized-playback` & `old-quality-layout` wrong opcodes ([b45d175](https://github.com/PalmDevs/rvp/commit/b45d175c6f1ece6da894ab16128c2644d262c9c7))
* `minimized-playback` patch ([55677a4](https://github.com/PalmDevs/rvp/commit/55677a44ff965c0b92c3f1d771bd68c12c142ad4))
* `minimized-playback` patch for YouTube Kids videos ([#201](https://github.com/PalmDevs/rvp/issues/201)) ([31e3b42](https://github.com/PalmDevs/rvp/commit/31e3b42c6bbce0d00f049b8a69bafc94900bb3b4))
* `old-quality-layout` patch ([2497425](https://github.com/PalmDevs/rvp/commit/2497425c9f11b8b14c861c2f0f34ff47bdbfac53))
* `Patch` annotation for `client-spoof` patch ([6a8af47](https://github.com/PalmDevs/rvp/commit/6a8af47f2dfb319a53db9b5f9deb0392f10f4185))
* `seekbar-tapping` toggling ([#401](https://github.com/PalmDevs/rvp/issues/401)) ([5550244](https://github.com/PalmDevs/rvp/commit/55502446ce5967922f2e9711a5fea2758fe31e83))
* `SignatureChecker` not handling nullable field `methodMetadata` ([17bcf78](https://github.com/PalmDevs/rvp/commit/17bcf786a85ccf1f7d9f5a66a044a3c26def09bb))
* `swipe-controls` with active engagement panel ([#177](https://github.com/PalmDevs/rvp/issues/177)) ([000ec6d](https://github.com/PalmDevs/rvp/commit/000ec6d8f6ecbb910a06ec852564ee9e5f03dcf8))
* accidentally removed code in refactor ([0077e26](https://github.com/PalmDevs/rvp/commit/0077e26d23cc112b671a41614a55348fac2c88ca))
* actually call `VideoInformation.setCurrentVideoId` first ([5c62d0a](https://github.com/PalmDevs/rvp/commit/5c62d0a2e0217de1b9563a41b4e94ed63230440f))
* add `patches.json` as a release asset ([a0b2c89](https://github.com/PalmDevs/rvp/commit/a0b2c89071d64efa7629a8d6d6bc0492c9772aa9))
* add 17.25.34 as supported version for swipe-controls patch ([4d84c19](https://github.com/PalmDevs/rvp/commit/4d84c1914f8ecf51cee25667219bc6cf635a6c1c))
* add execute permission to `./gradlew` file ([ff7a560](https://github.com/PalmDevs/rvp/commit/ff7a5602f68428111fea6c60cbea694592039ef1))
* add missing `trimIndent()` to string literals ([76d3c71](https://github.com/PalmDevs/rvp/commit/76d3c71b67edebd79f2cdb1bb28e4d2969d72223))
* add missing opcode for `create-button-method` ([0a398ef](https://github.com/PalmDevs/rvp/commit/0a398ef364f91a0dd9608df1a036a2515476ccf2))
* add missing permission to reboot app ([#260](https://github.com/PalmDevs/rvp/issues/260)) ([6ced6df](https://github.com/PalmDevs/rvp/commit/6ced6df8ed7642dea51e1acd1c12f4de4874b972))
* add missing switch for `tablet-mini-player` patch ([244a1b2](https://github.com/PalmDevs/rvp/commit/244a1b2cb9f77272dc62287a4a34a487b0289295))
* add missing switch for tablet mini-player ([b824d35](https://github.com/PalmDevs/rvp/commit/b824d35960df9e99c2a2d248356c3c9342cfe130))
* add size `48px` for `custom-branding` patch ([f81872b](https://github.com/PalmDevs/rvp/commit/f81872b8e41da215517fdb59364130d8ce681607))
* add v17.28.34 compatiblity for the `hide-shorts-button` patch ([#224](https://github.com/PalmDevs/rvp/issues/224)) ([76166bb](https://github.com/PalmDevs/rvp/commit/76166bb35f940ef661e2802f5bf93ed91f2e2913))
* alignment of download button icon ([#477](https://github.com/PalmDevs/rvp/issues/477)) ([2093f11](https://github.com/PalmDevs/rvp/commit/2093f11e762c471a0987fb57f03c7f48d565fdce))
* **anytracker:** syntax error in fingerprint ([#1165](https://github.com/PalmDevs/rvp/issues/1165)) ([3db1e12](https://github.com/PalmDevs/rvp/commit/3db1e1211fb8786f3109152559633dab895f607b))
* apply multiple changes from integrations, refactor package structure, class names and implementations ([e756fac](https://github.com/PalmDevs/rvp/commit/e756face362e4abf2c7b17afa536feed9b0cd631))
* attempt on all patches ([3395d69](https://github.com/PalmDevs/rvp/commit/3395d69747103a4bdf314297aa0bfa6ef6a0fc36))
* autoplay not working. ([586eed5](https://github.com/PalmDevs/rvp/commit/586eed515fc7ff8e3b1b150b0d34610b39480bb5))
* autoplay still enabled when using patch ([4f96129](https://github.com/PalmDevs/rvp/commit/4f961298f6cb6417ee3f3d6f8ac7ce96594ed03b))
* breaking changes by `revanced-patcher` dependency ([e12e484](https://github.com/PalmDevs/rvp/commit/e12e484e3796c5c9c8505b677838cdf8432f2e79))
* breaking changes by `revanced-patcher` dependency ([7e485b4](https://github.com/PalmDevs/rvp/commit/7e485b4ffe204d724809aeb9bd9f693a35ded94d))
* breaking changes of the patcher ([1a49bbd](https://github.com/PalmDevs/rvp/commit/1a49bbdbc4ff6f427934259536218e161908b449))
* breaking patcher changes ([50f9cc5](https://github.com/PalmDevs/rvp/commit/50f9cc52acfd5bc23330ecd23d8d85678a9d3eee))
* breaking patcher changes ([cbb9e2c](https://github.com/PalmDevs/rvp/commit/cbb9e2cd1fa829e1d1dd92dbd40131b11ae6a05b))
* breaking patcher changes ([581d1b0](https://github.com/PalmDevs/rvp/commit/581d1b0ca7d15adcdb1ab6116ef035acfe701757))
* broken gradle task ([91483a8](https://github.com/PalmDevs/rvp/commit/91483a8fbf92559d079dc52f846f5f871f5d6b5c))
* broken gradle task ([4d07961](https://github.com/PalmDevs/rvp/commit/4d07961c8afd24da7f8879d11419147f2e100f05))
* broken gradle task ([28e3f55](https://github.com/PalmDevs/rvp/commit/28e3f554ea6a7144416523fe48ce7adbb613b263))
* bugfixes in `microg` ([a43b33b](https://github.com/PalmDevs/rvp/commit/a43b33bdbb2b36e0a8f991fa11dfeeec34de01f9))
* bump bundle version to 2.141.0 ([abebe61](https://github.com/PalmDevs/rvp/commit/abebe61ba61a70f960df681e03803b33bae5726f))
* bump youtube version for swipe-controls patch ([ff207a5](https://github.com/PalmDevs/rvp/commit/ff207a57af7d3c15a8127f4465e97da23878b0d6))
* bump youtube version to 17.27.39 ([b93401a](https://github.com/PalmDevs/rvp/commit/b93401a391c0ed4887dd1376ac253f74f98a8d7e))
* bump youtube version to 17.28.34 ([#225](https://github.com/PalmDevs/rvp/issues/225)) ([738cb6a](https://github.com/PalmDevs/rvp/commit/738cb6af177e92bbff8c02d6808fe416c0ad2582))
* bump youtube version to 17.29.34 ([#236](https://github.com/PalmDevs/rvp/issues/236)) ([be6494a](https://github.com/PalmDevs/rvp/commit/be6494a80989044cba961dc22fc58ffb2e8591f0))
* change fingerprint to work on latest youtube ([#80](https://github.com/PalmDevs/rvp/issues/80)) ([4dba323](https://github.com/PalmDevs/rvp/commit/4dba323ddf8980cd2b0908a0de41c4b4dea6b0d7))
* changed default value for autorepeat setting ([#386](https://github.com/PalmDevs/rvp/issues/386)) ([d43add7](https://github.com/PalmDevs/rvp/commit/d43add7c21f0d9f45830476704985755e37d33ef))
* check if node has attributes before accessing them ([2d2ed87](https://github.com/PalmDevs/rvp/commit/2d2ed870dacfe092eb6acbcaae5e51775c611322))
* check if resource files exist ([ba1f3af](https://github.com/PalmDevs/rvp/commit/ba1f3af99be58edc44ed1b8f1875508d5034efd8))
* clean after building ([a2df3fb](https://github.com/PalmDevs/rvp/commit/a2df3fbc9761b07f3010542fa8684ade00e4dc91))
* cleanup & trigger release for ThemePatch ([8d25b21](https://github.com/PalmDevs/rvp/commit/8d25b214e297797092432b5fe1a4ede1f42115c8)), closes [#447](https://github.com/PalmDevs/rvp/issues/447) [revanced/revanced-patcher#99](https://github.com/revanced/revanced-patcher/issues/99)
* compatibility of `force-vp9-codec-parent-fingerprint` fingerprint with version `17.27.39` ([523fd86](https://github.com/PalmDevs/rvp/commit/523fd8627bc965a724267f725c28fba5e7a25a04))
* constrain `old-quality-layout` to older version ([add7232](https://github.com/PalmDevs/rvp/commit/add72326199e90f677b450b553b9d88c0bb4c490))
* correct title for `tablet-miniplayer` setting switch ([6af6c02](https://github.com/PalmDevs/rvp/commit/6af6c02154d170153093bd846dfcb7a6205dd6fa))
* crash when using force-vp9-codec patch ([7a35e5c](https://github.com/PalmDevs/rvp/commit/7a35e5c985b412d5a84083d1416d3207a40b3e97))
* **custom-playback-speed:** implement own method instead of `takeWhile` ([8522d4c](https://github.com/PalmDevs/rvp/commit/8522d4cd705118bf1108ec88bbed542a0cb15943))
* **custom-video-buffer:** use correct offset for `getMaxBuffer` call injection ([6773122](https://github.com/PalmDevs/rvp/commit/6773122d0b1598af78d4619b8af2811be11f6b95))
* default values for settings ([834c4ad](https://github.com/PalmDevs/rvp/commit/834c4add71570d36b645246621ba24da3869d613))
* design language for download icon ([#464](https://github.com/PalmDevs/rvp/issues/464)) ([c24dc17](https://github.com/PalmDevs/rvp/commit/c24dc175f705fd5364b8bcf01f27f3ac8ecc0e64))
* disable `hide-suggestions-patch` patch until fixed ([99099ea](https://github.com/PalmDevs/rvp/commit/99099ea0bc12f5f25896967db642442df69d0c4f))
* disable cast modules in YouTube Music ([#337](https://github.com/PalmDevs/rvp/issues/337)) ([86eaba8](https://github.com/PalmDevs/rvp/commit/86eaba8248100987f46540a224956099bcf9da2c))
* **disable-auto-player-popup-panels:** swap switch toggle state description ([#653](https://github.com/PalmDevs/rvp/issues/653)) ([f881301](https://github.com/PalmDevs/rvp/commit/f88130143689c7a63fd67df3dff37caec5db9548))
* disable-fullscreen-panels patch not working ([#213](https://github.com/PalmDevs/rvp/issues/213)) ([5372105](https://github.com/PalmDevs/rvp/commit/5372105e72607f289b779e4c2a3c13f3458842ce))
* **disable-startup-shorts-player:** incorrect offsets, invert branch condition ([#672](https://github.com/PalmDevs/rvp/issues/672)) ([bfe1e38](https://github.com/PalmDevs/rvp/commit/bfe1e3808ece85fbb0785a4378ee95591115ac33))
* **disable-startup-shorts-player:** remove redundant opcode pattern ([#679](https://github.com/PalmDevs/rvp/issues/679)) ([5197a24](https://github.com/PalmDevs/rvp/commit/5197a24cc5ecc1b51cdc5c00c77c873b86394994))
* display codename for patch names ([10c53f7](https://github.com/PalmDevs/rvp/commit/10c53f720df3e70b9d59e8bc3219d56b996f03db))
* do not constrain `amoled` patch to versions ([#408](https://github.com/PalmDevs/rvp/issues/408)) ([4af1714](https://github.com/PalmDevs/rvp/commit/4af1714dae4da40fe7488e8b734da91c978f1bdf))
* don't overwrite register in `compact-header` patch ([#406](https://github.com/PalmDevs/rvp/issues/406)) ([3da8ab5](https://github.com/PalmDevs/rvp/commit/3da8ab5702f5c2a0384ce85fcb3df3b837cdc90e))
* don't respect primary color for the download button icon ([#424](https://github.com/PalmDevs/rvp/issues/424)) ([3fa70f4](https://github.com/PalmDevs/rvp/commit/3fa70f48a206c56f6ca8aed88baed722e76281e2))
* dummy task for Gradle semantic-release plugin ([f6a8911](https://github.com/PalmDevs/rvp/commit/f6a8911906dfe52fcdb685daf7a02d6d0052cba9))
* environment variable not found in gradle build script ([0da15fb](https://github.com/PalmDevs/rvp/commit/0da15fb0effac0566d080d7b85e9fbe46c3dd34d))
* exclude `swipe-controls` by default due to instability ([bdeb8e0](https://github.com/PalmDevs/rvp/commit/bdeb8e04609a0ca94d9e2921bf7d486b9e229cec))
* forgot about this ([7102a25](https://github.com/PalmDevs/rvp/commit/7102a25dc618f19b324b01870d23f5418f375b2a))
* freezing panels when watching video in fullscreen ([#89](https://github.com/PalmDevs/rvp/issues/89)) ([f5d4f6c](https://github.com/PalmDevs/rvp/commit/f5d4f6c3419916c6a9cf67babc6be8a64c854d3b))
* **general-ads:** invalid smali syntax ([86224c1](https://github.com/PalmDevs/rvp/commit/86224c1f601c1bd22c0ce4dcf2a8e79ea3b8b2ae))
* get create button view register by more reliable means ([#59](https://github.com/PalmDevs/rvp/issues/59)) ([6ab821e](https://github.com/PalmDevs/rvp/commit/6ab821e377176f4e9f1b7ec2b58a924fa40299db))
* **hdr-auto-brightness:** increase patching compatibility across versions ([bc5c8c1](https://github.com/PalmDevs/rvp/commit/bc5c8c118d5f95905fb7f0fb6afaf97bdcb753bf))
* **hdr-brightness:** trim list of compatible versions ([#602](https://github.com/PalmDevs/rvp/issues/602)) ([3209d90](https://github.com/PalmDevs/rvp/commit/3209d902e4d1aa73b59ce059cf3f76ef2095af70))
* **hide-create-button:** increase patching compatibility across versions ([b217a1e](https://github.com/PalmDevs/rvp/commit/b217a1e89f4b9e3ad030ece08a1b81e507c7cc02))
* **hide-email-address:** invalid instruction offsets ([#654](https://github.com/PalmDevs/rvp/issues/654)) ([1a3db44](https://github.com/PalmDevs/rvp/commit/1a3db44b5bd9628b7b25cc113a3a53bf8a85bd2b))
* **hide-premium-nav-bar:** invalid import ([#590](https://github.com/PalmDevs/rvp/issues/590)) ([37ad223](https://github.com/PalmDevs/rvp/commit/37ad22360e6ac5e1b1dce474fe6a4e3813e03330))
* **hide-premium-navbar:** remove the correct instructions ([#591](https://github.com/PalmDevs/rvp/issues/591)) ([b4b0c97](https://github.com/PalmDevs/rvp/commit/b4b0c972d28cf7591ece04d154d1183c8431cb77))
* **hide-shorts-button:** increase patching compatibility across versions ([7f17934](https://github.com/PalmDevs/rvp/commit/7f1793490f25b9fa16539e80cdc417b3b3e0e639))
* **hide-time-and-seekbar:** don't draw the seekbar ([#594](https://github.com/PalmDevs/rvp/issues/594)) ([46e0195](https://github.com/PalmDevs/rvp/commit/46e0195f760dc11ec8d2068ffb57997eccab1aff))
* inconsistencies in preference switches ([#1207](https://github.com/PalmDevs/rvp/issues/1207)) ([bb0985a](https://github.com/PalmDevs/rvp/commit/bb0985a03ecb813d03d0e65370000e44ea5e65ee))
* incorrect compatibilty attribute ([#296](https://github.com/PalmDevs/rvp/issues/296)) ([0ab3e97](https://github.com/PalmDevs/rvp/commit/0ab3e9724157c628555964273c6b65f9f48f9664))
* incorrect endIndex (fixed in Patcher) ([424788e](https://github.com/PalmDevs/rvp/commit/424788edd777110cdaff97500556d18628f33385))
* incorrect fingerprint version [skip ci] ([f8c62ae](https://github.com/PalmDevs/rvp/commit/f8c62ae16b088ff6d0e96a4ef62dc707cd83beb9))
* incorrect package name in gradle task ([152b2c9](https://github.com/PalmDevs/rvp/commit/152b2c90cf102170648fcc168da10f46743bdc63))
* invalid regex ([26bf1d8](https://github.com/PalmDevs/rvp/commit/26bf1d818f953abc061126d8b91f17cd9008ba1d))
* invalid string in strings list ([f08b53b](https://github.com/PalmDevs/rvp/commit/f08b53b07d93bd8ac6e7da376ea6e6023e53076e))
* invalid version in compatibility annotation ([#90](https://github.com/PalmDevs/rvp/issues/90)) ([df43547](https://github.com/PalmDevs/rvp/commit/df435475cdd0494a1e4ea9e2980c2998c9bc7048))
* listing of wrong fingerprint class ([#147](https://github.com/PalmDevs/rvp/issues/147)) ([95c2bbd](https://github.com/PalmDevs/rvp/commit/95c2bbdd1deb1d76f1177b48286fa6a3bc9f7663))
* loop in `amoled` patch ([c4c86b6](https://github.com/PalmDevs/rvp/commit/c4c86b65fd8b2463c1d86ad2e46ec9f08e60d47c))
* make `custom-branding` cross-platform ([#366](https://github.com/PalmDevs/rvp/issues/366)) ([02ac62b](https://github.com/PalmDevs/rvp/commit/02ac62b0ea7e47ff3aa5078ce4645421f410b154))
* make `minimized-playback-manager-fingerprint` unique ([#120](https://github.com/PalmDevs/rvp/issues/120)) ([cd5e911](https://github.com/PalmDevs/rvp/commit/cd5e911f4ed9ad95b02c13c30cd9466d250e8904))
* make all patches toggleable with settings ([#202](https://github.com/PalmDevs/rvp/issues/202)) ([7e1d82f](https://github.com/PalmDevs/rvp/commit/7e1d82f1161237632c3a57f109db6b8903006b33))
* **metanav/fix-scaling:** use semantic versioning in package versions ([a9445a8](https://github.com/PalmDevs/rvp/commit/a9445a823e3a4885764cea9d08b51a1584d3238f))
* migrate patches to latest patcher api changes ([8a0ee03](https://github.com/PalmDevs/rvp/commit/8a0ee03a71cf4a000c9a7246d0e64ed8291a5127))
* migrate to `include` annotation ([110bbf1](https://github.com/PalmDevs/rvp/commit/110bbf143a9cec8dce1f0416cff40f8d93055e96))
* migrate to breaking changes from patcher ([2c0a419](https://github.com/PalmDevs/rvp/commit/2c0a4196fed2fbdcd454ed882b720898d3050c51))
* migrate to new `proxy` api ([db32ffe](https://github.com/PalmDevs/rvp/commit/db32ffe56a8e73177bef724ee10eda9a28b367b8))
* migrate to new patcher api ([f43446e](https://github.com/PalmDevs/rvp/commit/f43446ed189e583302fcd899f5eb7517f2a77144))
* missing brackets at inlining ([8936c8a](https://github.com/PalmDevs/rvp/commit/8936c8aaedb56817cda5eec5f4a8c32f433862aa))
* missing extension method `doRecursively` ([e9c9460](https://github.com/PalmDevs/rvp/commit/e9c946008ee912652d288e515b83b52ae2d239d8))
* modified opcode for `show-video-ads-constructor` ([a0dcea3](https://github.com/PalmDevs/rvp/commit/a0dcea3a13f68cae449dfaf445b542e339c83ff0))
* multiple bugs in patches ([e37201d](https://github.com/PalmDevs/rvp/commit/e37201d0ceef474696857a0d8845950c888194d0))
* multiple compatible pkgs on readme ([3f82a13](https://github.com/PalmDevs/rvp/commit/3f82a1349fb11b1152ac10d76deb930f7325b7c9))
* name for `IntegrationsPatch` ([e46ef02](https://github.com/PalmDevs/rvp/commit/e46ef02302825d62b57912b2747a25f858036bb7))
* old usage of `toInstructions` extension method ([65ddd52](https://github.com/PalmDevs/rvp/commit/65ddd522dca19e0590d9cb6fdb2d85ad7b98481e))
* package name for Vanced ([#390](https://github.com/PalmDevs/rvp/issues/390)) ([85206b9](https://github.com/PalmDevs/rvp/commit/85206b99e1399d00e5eaebded8aadc5fb982aaa4))
* partial ad blockage in `tiktok-ads` patch ([#420](https://github.com/PalmDevs/rvp/issues/420)) ([bc6d192](https://github.com/PalmDevs/rvp/commit/bc6d19205940e3b4b228a9b5de627a2260abd00e))
* patch description consistency ([#134](https://github.com/PalmDevs/rvp/issues/134)) ([da5896d](https://github.com/PalmDevs/rvp/commit/da5896dde0a2b2b9ffe65e486402e4ef92ec1ce9))
* patcher not propagating dexlib ([980c486](https://github.com/PalmDevs/rvp/commit/980c48673259496d793bc7f864ad355188dcf7b6))
* path for download icon ([#465](https://github.com/PalmDevs/rvp/issues/465)) ([bff22c3](https://github.com/PalmDevs/rvp/commit/bff22c3a154fd8059f4f8995a303354633a50517))
* print instruction index of warning ([9e29aee](https://github.com/PalmDevs/rvp/commit/9e29aeeeff222412f6c45cf7e4879f8ec53ca6ee))
* publish releases ([83916f9](https://github.com/PalmDevs/rvp/commit/83916f96d27989dcbb35c0ba6ef326a16b470501))
* put back proper variable ([#61](https://github.com/PalmDevs/rvp/issues/61)) ([d26c423](https://github.com/PalmDevs/rvp/commit/d26c4233031fd418eb37c8f05e9bc1857e0572e6))
* Readd `swipe-controls` patch ([#123](https://github.com/PalmDevs/rvp/issues/123)) ([7f2a2b2](https://github.com/PalmDevs/rvp/commit/7f2a2b2ee4e6045d53aba4e7705431b643981107))
* references to integrations in `return-youtube-dislike` patch ([5824c2c](https://github.com/PalmDevs/rvp/commit/5824c2cdfb1a2d7b8d68044388e5e0746ef2ca09))
* release `patches.json` file ([#402](https://github.com/PalmDevs/rvp/issues/402)) ([17e351c](https://github.com/PalmDevs/rvp/commit/17e351c99a69652f20d89e579f43c1ce110cd81d))
* releases ([30d5c9a](https://github.com/PalmDevs/rvp/commit/30d5c9a67ccf88ca6ac00d0a9f2a2e330f8092dd))
* remove `HideSuggestionsPatch` from `Index` ([f32e474](https://github.com/PalmDevs/rvp/commit/f32e4747b512c675b807ff5eebfd0b8e66173fba))
* remove broken video-quality patch ([e8d516a](https://github.com/PalmDevs/rvp/commit/e8d516af896971a09bb9aca8b00e7b7bb57c3dd9))
* remove refreshing home screen not working ([6c24ebe](https://github.com/PalmDevs/rvp/commit/6c24ebef2fb4f0d58e369ac5bf63e4cab6ca0e80))
* remove requirement for solution [skip ci] ([#271](https://github.com/PalmDevs/rvp/issues/271)) ([553fad3](https://github.com/PalmDevs/rvp/commit/553fad3fe1bb79bdf34e9f91c0e1cbfda78e1054))
* remove unnecessary version constraints ([#117](https://github.com/PalmDevs/rvp/issues/117)) ([1cddf8d](https://github.com/PalmDevs/rvp/commit/1cddf8d9063da3bbdba0fd7080c8c93768b83a4c))
* remove unused patches ([d12e92a](https://github.com/PalmDevs/rvp/commit/d12e92aead677fefa9dcb48748d783225b65fab1))
* rename `default-video-quality` to `remember-video-quality` ([7f6cdfd](https://github.com/PalmDevs/rvp/commit/7f6cdfd7c2b5e72742bbb92e4d584f722cb82cae))
* rename autorepeat-by-default patch to always-autorepeat ([3606015](https://github.com/PalmDevs/rvp/commit/3606015d715f150cc51fbb29adf3be252b96faab))
* resolve fingerprint in `premium-icon-reddit` patch ([#413](https://github.com/PalmDevs/rvp/issues/413)) ([60ec2c6](https://github.com/PalmDevs/rvp/commit/60ec2c6f8a29cfc36313617a92e976f01213ce00))
* revert `swipe-controls` patch  ([66e1f33](https://github.com/PalmDevs/rvp/commit/66e1f3384a58361737ba889d946be875b23f3163))
* rollback to `Dependencies` annotation ([36a2ae8](https://github.com/PalmDevs/rvp/commit/36a2ae886c63f1d22bb1cca9e7110af6c3f6f2d3))
* run meta generator ([70a2b45](https://github.com/PalmDevs/rvp/commit/70a2b456b4031b3da38a18a71ede7bf84099acd0))
* **seekbar-tapping:** do not disable seekbar when hiding it ([#600](https://github.com/PalmDevs/rvp/issues/600)) ([68a9457](https://github.com/PalmDevs/rvp/commit/68a9457464c786a61b756eb18ca5f1ce05316636))
* show minimized playback options in settings ([#118](https://github.com/PalmDevs/rvp/issues/118)) ([6e1a538](https://github.com/PalmDevs/rvp/commit/6e1a538d34291d75f19bf66a188bc69241de3a7a))
* signature checker with changes of patcher ([e82459d](https://github.com/PalmDevs/rvp/commit/e82459d37759e1a5a860d3e7fcdf69d95b06858e))
* some more refactoring of integrations, add hide-watermark patch ([#63](https://github.com/PalmDevs/rvp/issues/63)) ([feb09c5](https://github.com/PalmDevs/rvp/commit/feb09c56f475e2537a67d3636b08737848158a8e))
* spelling mistake ([52f9147](https://github.com/PalmDevs/rvp/commit/52f9147ee8d591f786397d174dc02a141d9250a9))
* **sponsorblock:** broken fingerprint and invert setting `shorts_playing` ([#579](https://github.com/PalmDevs/rvp/issues/579)) ([59fb674](https://github.com/PalmDevs/rvp/commit/59fb674437207aeabed5b92ba32bda120820fb8f))
* **sponsorblock:** correct class name for field reference ([#582](https://github.com/PalmDevs/rvp/issues/582)) ([7cd585c](https://github.com/PalmDevs/rvp/commit/7cd585cd78e284a82cee17d09f8049f0a5cdf2e8))
* **sponsorblock:** dynamically insert `setSponsorBarRect` call ([#644](https://github.com/PalmDevs/rvp/issues/644)) ([998a249](https://github.com/PalmDevs/rvp/commit/998a249a23d09eb752b35c4da731f4223be40a3b))
* **sponsorblock:** reflect changes to strings ([#585](https://github.com/PalmDevs/rvp/issues/585)) ([d03568a](https://github.com/PalmDevs/rvp/commit/d03568aa39195a07bec62f43d929923825c67d3f))
* **sponsorblock:** reflect strings from official guidelines ([#523](https://github.com/PalmDevs/rvp/issues/523)) ([1c83959](https://github.com/PalmDevs/rvp/commit/1c83959e69bfbf5140edbf7ef4d2c8901975bfd4))
* **sponsorblock:** resolve unresolved fingerprint ([e7296f3](https://github.com/PalmDevs/rvp/commit/e7296f3424bed78a0149cca9bf6e29243e962150))
* spoof `X-Android-Cert` of Firebase `authToken` api request ([#315](https://github.com/PalmDevs/rvp/issues/315)) ([c81d61f](https://github.com/PalmDevs/rvp/commit/c81d61f685449590473fa5205e7709f81872a9b9))
* **spotify/disable-capture-restriction:** dynamically find indices ([#759](https://github.com/PalmDevs/rvp/issues/759)) ([2cc64c6](https://github.com/PalmDevs/rvp/commit/2cc64c61d1bc18a1717354085ddc60a251173837))
* sync version ([6170e36](https://github.com/PalmDevs/rvp/commit/6170e3689d9c8998be94a8464352af620cccd11b))
* syntax error in compatiblity annotation ([#1181](https://github.com/PalmDevs/rvp/issues/1181)) ([2b555f6](https://github.com/PalmDevs/rvp/commit/2b555f626c0e9b78f896bb415890fd4f80a870c6))
* tests failing ([102793f](https://github.com/PalmDevs/rvp/commit/102793f24f8bf7c7fd254968b29d65da7b2b962f))
* **theme:** include coloring the playlist action bar ([#742](https://github.com/PalmDevs/rvp/issues/742)) ([6766ec8](https://github.com/PalmDevs/rvp/commit/6766ec8f31da6dd71fff0ae4b7044af5ec4a5dfd))
* **tiktok/settings:** make compatible with newer versions ([#1057](https://github.com/PalmDevs/rvp/issues/1057)) ([0ca4bce](https://github.com/PalmDevs/rvp/commit/0ca4bce1c5ceb61182eac98223b0ca4b4c2b833d))
* **tiktok/tiktok-downloads:** add missing patch dependencies ([#686](https://github.com/PalmDevs/rvp/issues/686)) ([5c3b4ed](https://github.com/PalmDevs/rvp/commit/5c3b4ed0530e89d50db3b5bb9893e1ef4b463bae))
* trigger release on `build` commits ([be8bd1b](https://github.com/PalmDevs/rvp/commit/be8bd1b2a4b91f9763448661a802a5dc4a6b1d1d))
* **twitter patches.:** use wider compatible Java API for writing to file ([#678](https://github.com/PalmDevs/rvp/issues/678)) ([4448de8](https://github.com/PalmDevs/rvp/commit/4448de80a6277862d81c7a29b9489e4fbec48496))
* **twitter/monochrome-icon:** add missing `File.write` call ([#682](https://github.com/PalmDevs/rvp/issues/682)) ([de22e3f](https://github.com/PalmDevs/rvp/commit/de22e3f03ef1d6db08f9446f02e687721d9017d7))
* update `HomeAdsPatch` ([62f1801](https://github.com/PalmDevs/rvp/commit/62f1801e9cbee53c0be3413c245161bd941e4aec))
* update patcher version ([e3d0bb7](https://github.com/PalmDevs/rvp/commit/e3d0bb7ee1923ea996cf637267c62d233a74c7fa))
* update patcher version ([5f54bc9](https://github.com/PalmDevs/rvp/commit/5f54bc9aa8fd8b83448141a9b05746e3e977369d))
* update patcher version ([#35](https://github.com/PalmDevs/rvp/issues/35)) ([1a379df](https://github.com/PalmDevs/rvp/commit/1a379dfd974b9f92d4bd0d5d7a4711eb6d1060b3)), closes [#34](https://github.com/PalmDevs/rvp/issues/34)
* update patches ([91b8ec8](https://github.com/PalmDevs/rvp/commit/91b8ec81f33417798546c32db708fe09ada3930c))
* update patches to `17.26.35` ([#142](https://github.com/PalmDevs/rvp/issues/142)) ([b04112c](https://github.com/PalmDevs/rvp/commit/b04112c8562a7b95e7555e894b665913094b33eb))
* use dependency in correct patch ([a2a1ee8](https://github.com/PalmDevs/rvp/commit/a2a1ee8eb5e059b30fe58c918a80976ef4d7b637))
* use original app name ([#977](https://github.com/PalmDevs/rvp/issues/977)) ([ffc3c08](https://github.com/PalmDevs/rvp/commit/ffc3c08d96734893121397d506a97bd50b06bc1d))
* use the latest version of patcher dependency ([fe4a439](https://github.com/PalmDevs/rvp/commit/fe4a439cb2bc5e385ae13e8e155f25bb15e74633))
* version in package metadata of music ([b299205](https://github.com/PalmDevs/rvp/commit/b299205aa7cde82f1f55fc598de3ff8d80b8bcb0))
* **video-ads:** block remaining video ads ([fbc83a2](https://github.com/PalmDevs/rvp/commit/fbc83a22d37012394311a87d27202b7cc86e047d))
* **video-ads:** clobber unused register ([0feb607](https://github.com/PalmDevs/rvp/commit/0feb6073dd3de5dc179ffa9fde2da24439986431))
* **video-ads:** invert the condition to hide ads ([a32af95](https://github.com/PalmDevs/rvp/commit/a32af951566a7187ae2618ef08f9298f78f8ea8c))
* **video-ads:** return empty ad list instead of null ([f6c5027](https://github.com/PalmDevs/rvp/commit/f6c5027981a2b55bbcd2e55d294ebfd5e6f0b527))
* **video-ads:** return empty list in correct method ([bbcf050](https://github.com/PalmDevs/rvp/commit/bbcf0501d4be0c43eddb7a9b3c32394222efc8f0))
* **VideoAds:** remove `istore1` opcode ([dc4ec57](https://github.com/PalmDevs/rvp/commit/dc4ec574414c5df959efa0ca8f1cd39a812fedf8))
* wording [skip ci] ([ba64d9e](https://github.com/PalmDevs/rvp/commit/ba64d9efc3ee606e9bda30ad7f8017af34b1dc3f))
* wrap theme option ([150c173](https://github.com/PalmDevs/rvp/commit/150c173adce31d9984d6feca694b472649233056))
* write while reading resources and remove checking for "." in resource extensions ([7bc6094](https://github.com/PalmDevs/rvp/commit/7bc60943cb2350e89dac091ec9c98c5effd0b8a9))
* wrong access flag in signature for `Create button patch` ([9fbb89d](https://github.com/PalmDevs/rvp/commit/9fbb89d05336a256a0759eea6095e073946c45e5))
* wrong annotation and signature in patches ([a0fdee8](https://github.com/PalmDevs/rvp/commit/a0fdee81a6d6773603520e7c3040ae8637642d58))
* wrong dependency version ([1e63a57](https://github.com/PalmDevs/rvp/commit/1e63a57b86475670442e6a24a7f24c02dabee239))
* wrong dex path ([170fbbb](https://github.com/PalmDevs/rvp/commit/170fbbb99e4a2dbe3e0febe44d07a692aa9d7224))
* wrong opcode for `create-button-method` ([3214650](https://github.com/PalmDevs/rvp/commit/32146506f139aebc44cd5faffb7706b8b9c21c3d))
* wrong opcode pattern for `create-button-method` ([f4d8a85](https://github.com/PalmDevs/rvp/commit/f4d8a8525bc64b90748b21979d463977a21dcd85))
* wrong opcode pattern for `enable-seekbar-tapping-signature` ([1d83395](https://github.com/PalmDevs/rvp/commit/1d833957ed3e01188770c85e3d84e483419bd797))
* wrong opcode pattern for signature in `Hide suggestions patch` ([535aee0](https://github.com/PalmDevs/rvp/commit/535aee08408b990c80f5966c13fa84666a8b35d0))
* wrong patches in `upgrade-tab-remover` ([5182290](https://github.com/PalmDevs/rvp/commit/518229031ceca049ad790f7b77b19405d39f0ce1))
* wrong signature for `hide-reels-signature` ([2d9ff2a](https://github.com/PalmDevs/rvp/commit/2d9ff2af0a991d7721f3741187716a3b08bb4029))
* wrong signatures for patch `Old Quality Layout Patch` ([823e503](https://github.com/PalmDevs/rvp/commit/823e503d84037bdf27b09f17e63383f963c76854))
* wrong versions of patches ([a112b22](https://github.com/PalmDevs/rvp/commit/a112b22ce6e685204caab6f95f511e26ef95806b))
* **youtube/custom-branding:** use high resolution icons ([#1018](https://github.com/PalmDevs/rvp/issues/1018)) ([1c9d1ac](https://github.com/PalmDevs/rvp/commit/1c9d1acf2b7aff4cd52d17009ff01246f74d2214))
* **youtube/custom-branding:** use proper scaled icons ([24b5bcd](https://github.com/PalmDevs/rvp/commit/24b5bcdd703474c940fd436a37f0ae924d8b8c74))
* **youtube/custom-video-speed:** fuzzy scan on fingerprint  ([#1135](https://github.com/PalmDevs/rvp/issues/1135)) ([5ac1b26](https://github.com/PalmDevs/rvp/commit/5ac1b26ae2b298fbadd2db7c35e411b38ad15480))
* **youtube/disable-startup-shorts-player:** do not prevent playing videos on startup ([#714](https://github.com/PalmDevs/rvp/issues/714)) ([9a0d379](https://github.com/PalmDevs/rvp/commit/9a0d3798afd75bba5c63e1b8803dc25814586be9))
* **youtube/disable-startup-shorts-player:** don't affect functionality of navigation bar  ([#716](https://github.com/PalmDevs/rvp/issues/716)) ([05f5cc1](https://github.com/PalmDevs/rvp/commit/05f5cc17e3fcbf255c6fe5b503c9fd20c218f5a1))
* **youtube/general-ads:** hide ads on wide screens ([#765](https://github.com/PalmDevs/rvp/issues/765)) ([f0d2f3e](https://github.com/PalmDevs/rvp/commit/f0d2f3e01b90bbe6d2b55b941eaf96be2295cd3c))
* **youtube/general-ads:** hide ads with buttons ([d2d4afb](https://github.com/PalmDevs/rvp/commit/d2d4afbef37c6b0196574d25baa741c1b1ecc6ca))
* **youtube/general-ads:** hide bytecode home ad view ([7b33a6f](https://github.com/PalmDevs/rvp/commit/7b33a6f76c90aa6466f638a43f2b7c31a014ce1a))
* **youtube/general-ads:** hide reels shelf ([029a95b](https://github.com/PalmDevs/rvp/commit/029a95bafcf7687c8b24ab0d51a3d016fc33c241))
* **youtube/general-ads:** import correct compatibility annotation ([#1065](https://github.com/PalmDevs/rvp/issues/1065)) ([db2085c](https://github.com/PalmDevs/rvp/commit/db2085c217311a8b7d45a01c03c6162bc60a9298))
* **youtube/general-ads:** incorrect description for info panels ([77b029e](https://github.com/PalmDevs/rvp/commit/77b029e82e481a13516b1c8a888c42817507cdea))
* **youtube/general-ads:** remove unused switch ([e5fd11a](https://github.com/PalmDevs/rvp/commit/e5fd11a971325a4b80db1832a92856dcf5b4ca66))
* **youtube/hide-endscreen-cards:** restore functionality ([#993](https://github.com/PalmDevs/rvp/issues/993)) ([eb1bae2](https://github.com/PalmDevs/rvp/commit/eb1bae2c55e65ad29030dce6746a18662dd0fe25))
* **youtube/hide-info-cards:** remove initial popup of info-cards ([#992](https://github.com/PalmDevs/rvp/issues/992)) ([19f3f03](https://github.com/PalmDevs/rvp/commit/19f3f038585c313a969adf3d4095a60ab4c83ede))
* **youtube/hide-mix-playlists:** correct switch title, summary and defaults ([#821](https://github.com/PalmDevs/rvp/issues/821)) ([f9eea33](https://github.com/PalmDevs/rvp/commit/f9eea332cea0b8c3d5c3dfff645b60861e925b5a))
* **youtube/integrations:** set context for remaining activities ([#828](https://github.com/PalmDevs/rvp/issues/828)) ([b2b6a3d](https://github.com/PalmDevs/rvp/commit/b2b6a3d1492bc2d5a6e27c68c74e3904764dda4b))
* **youtube/litho-filter:** use correct type for switch case ([#1068](https://github.com/PalmDevs/rvp/issues/1068)) ([ab03511](https://github.com/PalmDevs/rvp/commit/ab03511e23d07c7c40b58eae5791fb2a798289de))
* **youtube/theme-patch:** respect app specific theme ([#946](https://github.com/PalmDevs/rvp/issues/946)) ([fe8d6c7](https://github.com/PalmDevs/rvp/commit/fe8d6c7b2c10be5cca0717b6a03cfa1bef10e2c0))
* **youtube/theme:** add missing theme condition check ([#771](https://github.com/PalmDevs/rvp/issues/771)) ([40b70b9](https://github.com/PalmDevs/rvp/commit/40b70b9f9a24cfbf76bcd69f562b87e5cfade66f))
* **youtube/theme:** colore the comment action bar ([#762](https://github.com/PalmDevs/rvp/issues/762)) ([4b3abe0](https://github.com/PalmDevs/rvp/commit/4b3abe0d45ac8c0c5ae6cf4955681ba76ce10309))
* **youtube/theme:** extend dark mode theming ([#827](https://github.com/PalmDevs/rvp/issues/827)) ([6d803c5](https://github.com/PalmDevs/rvp/commit/6d803c5386e1f6f6fb6a7fa0a9f0bb81ee1022ac))
* **youtube/theme:** theme litho ui components & use correct theme for settings ([#791](https://github.com/PalmDevs/rvp/issues/791)) ([91c03c5](https://github.com/PalmDevs/rvp/commit/91c03c5624ca28ac13ee761261dea423f0ac42d7))
* **youtube/theme:** theme missing gray color ([#873](https://github.com/PalmDevs/rvp/issues/873)) ([5267d56](https://github.com/PalmDevs/rvp/commit/5267d56a05b4053d556171ffd2d2870f3f932e8e))
* **youtube/video-ads:** add back initial method to block ads ([#818](https://github.com/PalmDevs/rvp/issues/818)) ([8b02acd](https://github.com/PalmDevs/rvp/commit/8b02acd3b33c4702d81ec46dccb35604ec5fbe02))
* **youtube/video-ads:** add switch to temporarily fix buffering issues ([7aa3bce](https://github.com/PalmDevs/rvp/commit/7aa3bce6ccd669a66de10ef6ffe2151f27b40365))
* **youtube/video-ads:** block earlier in call hirarchy ([#813](https://github.com/PalmDevs/rvp/issues/813)) ([f9517d2](https://github.com/PalmDevs/rvp/commit/f9517d2058c7561cf89b59ed36f690417dc076f7))
* **youtube/video-ads:** invert condition to hide ads ([e353ed0](https://github.com/PalmDevs/rvp/commit/e353ed0b0fe78feae65f1ad2f6567c1e9aa9c71d))
* **youtube/video-ads:** return empty ad list earlier ([a47ce9b](https://github.com/PalmDevs/rvp/commit/a47ce9ba4f75673de23eb6054f5652224a48f43e))
* **youtube/video-ads:** revert faulty method patch ([#820](https://github.com/PalmDevs/rvp/issues/820)) ([666248a](https://github.com/PalmDevs/rvp/commit/666248ae65d1ee84d1a278714c0dcd2528c5dd14))
* **youtube/video-information:** use correct compatibility annotation ([b42e048](https://github.com/PalmDevs/rvp/commit/b42e04884bb9a60c3df30b668bfba55b1cf8eaa4))
* **youtube:** resolve fingerprints on mutable methods ([10e4af3](https://github.com/PalmDevs/rvp/commit/10e4af386652d51c621519f7a67aac8c22ed8c18))
* **youtube:** swipe gesture on home screen ([e1d2e7b](https://github.com/PalmDevs/rvp/commit/e1d2e7bf430c969c94bc457f01f1642d533cbcea)), closes [#610](https://github.com/PalmDevs/rvp/issues/610)


### Code Refactoring

* migrate from `Signature` to `Fingerprint` ([084078e](https://github.com/PalmDevs/rvp/commit/084078e7f1852ccd2045e3fa8aedc25a7fd5faa8))
* Rename `net.revanced` to `app.revanced` ([68ea89f](https://github.com/PalmDevs/rvp/commit/68ea89f15e9ea077df0d0ac20a40b735bb5ae26c))


### Features

* `autorepeat-by-default` patch ([#106](https://github.com/PalmDevs/rvp/issues/106)) ([e0ac9f3](https://github.com/PalmDevs/rvp/commit/e0ac9f385fc360f4dd2451e26676633120356c10))
* `client-spoof` patch ([5512c07](https://github.com/PalmDevs/rvp/commit/5512c072fa4b047849dbea0d2d382dd85e3a0827))
* `comment` patch ([#858](https://github.com/PalmDevs/rvp/issues/858)) ([472fb4f](https://github.com/PalmDevs/rvp/commit/472fb4f3747c835be2c5069a0f65017ab42f8d7e))
* `compact-header` patch ([83753ba](https://github.com/PalmDevs/rvp/commit/83753bacf8f56ad16f8abafc02034f1595c12532))
* `custom-branding` patch ([0d65ea8](https://github.com/PalmDevs/rvp/commit/0d65ea8cdb0e02287f6be6855cd3d28823a61e70))
* `custom-playback-speed` patch ([#50](https://github.com/PalmDevs/rvp/issues/50)) ([224254b](https://github.com/PalmDevs/rvp/commit/224254bcce2b394bbfd2549089f0204ce4ed4a89))
* `default-video-quality` patch ([#141](https://github.com/PalmDevs/rvp/issues/141)) ([609ad7d](https://github.com/PalmDevs/rvp/commit/609ad7dee7e29b2ecc4e95a93e9dab1646b4b050))
* `Dependencies` annotation ([85806bb](https://github.com/PalmDevs/rvp/commit/85806bb355e342ecb33d4ee1e76f9edf89b2c2ee))
* `disable-auto-captions` patch ([#435](https://github.com/PalmDevs/rvp/issues/435)) ([8ee12d0](https://github.com/PalmDevs/rvp/commit/8ee12d0beadfd0a8fdce0a331646e8786527e84d))
* `disable-auto-player-popup-panels` ([#543](https://github.com/PalmDevs/rvp/issues/543)) ([d1fa2c3](https://github.com/PalmDevs/rvp/commit/d1fa2c3bc359018146f1f90b1ed4448b7f19b247))
* `disable-autoplay-button` patch ([#79](https://github.com/PalmDevs/rvp/issues/79)) ([0d6fb51](https://github.com/PalmDevs/rvp/commit/0d6fb51e025649aae37e230778ea367482fab0d7))
* `disable-capture-restriction` patch ([#655](https://github.com/PalmDevs/rvp/issues/655)) ([3cc26c3](https://github.com/PalmDevs/rvp/commit/3cc26c31d378c27ca7f768f777daa00e3f849dff))
* `disable-fullscreen-panels` patch ([3bf0561](https://github.com/PalmDevs/rvp/commit/3bf056163500b006d1a20c5f3a3e0c92fec13bd8))
* `disable-startup-shorts-player` patch ([#670](https://github.com/PalmDevs/rvp/issues/670)) ([feb3bd0](https://github.com/PalmDevs/rvp/commit/feb3bd02aaf67379733d10988fd58b0c3924f88e))
* `downloads` patch ([#215](https://github.com/PalmDevs/rvp/issues/215)) ([304fbac](https://github.com/PalmDevs/rvp/commit/304fbacab22538fb0945f564e061783b47120120))
* `dynamic-color` patch ([#652](https://github.com/PalmDevs/rvp/issues/652)) ([a16575b](https://github.com/PalmDevs/rvp/commit/a16575b984354138b9ab175307be8d15de60b6a6))
* `enable-debugging` patch ([#116](https://github.com/PalmDevs/rvp/issues/116)) ([bb355e7](https://github.com/PalmDevs/rvp/commit/bb355e7b7e78e602a10b346fe7e5795463615a81))
* `fix-metanav-scaling` patch ([#831](https://github.com/PalmDevs/rvp/issues/831)) ([4808e09](https://github.com/PalmDevs/rvp/commit/4808e099856e50a6f7e66834a92e2210cc84c8bc))
* `force-vp9-codec` patch ([#157](https://github.com/PalmDevs/rvp/issues/157)) ([07806a1](https://github.com/PalmDevs/rvp/commit/07806a16e5368118949e0e476e901987433ad403))
* `general-reddit-ads` patch ([#235](https://github.com/PalmDevs/rvp/issues/235)) ([d63c016](https://github.com/PalmDevs/rvp/commit/d63c016d38d2a5b1d152abccdb582990987a1911))
* `GeneralBytecodeAds` and `GeneralResourceAds` patch ([f99bbef](https://github.com/PalmDevs/rvp/commit/f99bbef4c911ac2492166c7a3792ea11ffceffab))
* `hdr-max-brightness` patch ([#105](https://github.com/PalmDevs/rvp/issues/105)) ([1310573](https://github.com/PalmDevs/rvp/commit/131057366a777786d6016d3385584b4e17bc4a8b))
* `hide-album-cards` patch ([#857](https://github.com/PalmDevs/rvp/issues/857)) ([bce9d0c](https://github.com/PalmDevs/rvp/commit/bce9d0c9405d7afd5c51c2a9c2c247f3ff7581f5))
* `hide-artist-card` patch ([#859](https://github.com/PalmDevs/rvp/issues/859)) ([1f76246](https://github.com/PalmDevs/rvp/commit/1f7624680b86e3a7afd45521bfef86f88f52c976))
* `hide-cast-button` patch ([2cd531e](https://github.com/PalmDevs/rvp/commit/2cd531eb5a334f3cf91cba4556f07e863cd9ec1b))
* `hide-crowdfunding-box` patch ([#856](https://github.com/PalmDevs/rvp/issues/856)) ([3704ce2](https://github.com/PalmDevs/rvp/commit/3704ce22dbbff02b2e2d6dbdf9a74254a2511d3c))
* `hide-email-address` patch ([#578](https://github.com/PalmDevs/rvp/issues/578)) ([82cb632](https://github.com/PalmDevs/rvp/commit/82cb6321beace1e5feed248d3f3d6ae56cf0d96b))
* `hide-get-premium` patch ([#195](https://github.com/PalmDevs/rvp/issues/195)) ([639aab4](https://github.com/PalmDevs/rvp/commit/639aab411ee514b50840c15c8e9a1a889854403f))
* `hide-infocard-suggestions` patch ([#107](https://github.com/PalmDevs/rvp/issues/107)) ([31a767a](https://github.com/PalmDevs/rvp/commit/31a767adbb152906303ab0ae5250769fc38d0625))
* `hide-premium-nav-bar` patch ([#589](https://github.com/PalmDevs/rvp/issues/589)) ([1811416](https://github.com/PalmDevs/rvp/commit/18114168d7f8c3dd41d1f124c3524c7ca850d33d))
* `hide-shorts-button` patch ([88352ee](https://github.com/PalmDevs/rvp/commit/88352ee6ecd23faa4a7fd9f7495e67fa1d3e33bd))
* `hide-time-and-seekbar` patch ([#544](https://github.com/PalmDevs/rvp/issues/544)) ([ef7afc7](https://github.com/PalmDevs/rvp/commit/ef7afc7231f8fa6b9b7f84c2b5b9a9fda80aa0f4))
* `hide-video-buttons` patch ([584803a](https://github.com/PalmDevs/rvp/commit/584803aa900f94de1b2b2a0c41fb0884fa9270d3))
* `hide-watch-in-vr` patch ([#911](https://github.com/PalmDevs/rvp/issues/911)) ([8ea0b20](https://github.com/PalmDevs/rvp/commit/8ea0b20e96df53211039df0468b2d4a735a381f1))
* `microg-patch` ([48bbd57](https://github.com/PalmDevs/rvp/commit/48bbd574a52c8bf6834b26facfe7384b830f944a))
* `minimize-playback-music` patch ([#200](https://github.com/PalmDevs/rvp/issues/200)) ([d4fd18b](https://github.com/PalmDevs/rvp/commit/d4fd18bc74c92e17cdfb21b627b2f6a8919ff2dc))
* `monochrome-icon` patch ([#643](https://github.com/PalmDevs/rvp/issues/643)) ([127c8e5](https://github.com/PalmDevs/rvp/commit/127c8e54e54709c2716029044ae337ad53daafad))
* `music-microg-support` patch ([#208](https://github.com/PalmDevs/rvp/issues/208)) ([50863e9](https://github.com/PalmDevs/rvp/commit/50863e97cc8eba7e1ad6d11b4821baa45fdd29c4))
* `music-video-ads` patch ([#172](https://github.com/PalmDevs/rvp/issues/172)) ([cbb71b5](https://github.com/PalmDevs/rvp/commit/cbb71b5faf1386ed31dd9e0387f6cf0509d92d31))
* `premium-heading` patch ([78913bf](https://github.com/PalmDevs/rvp/commit/78913bf1e80f5b91d0dee506fdfe3f875e8e6988))
* `premium-icon-reddit` patch ([#333](https://github.com/PalmDevs/rvp/issues/333)) ([6739e7b](https://github.com/PalmDevs/rvp/commit/6739e7b94c18200bb3afbc9a8465d97bd18d1945))
* `promo-code-unlock` patch ([#292](https://github.com/PalmDevs/rvp/issues/292)) ([d5df2e6](https://github.com/PalmDevs/rvp/commit/d5df2e68f47cbb3d374b8ce24769872959014051))
* `ResourceUtils` helper class ([e0e1144](https://github.com/PalmDevs/rvp/commit/e0e11447a7ac184d43c75955854c52c6992ff667))
* `return-youtube-dislikes` patch ([#175](https://github.com/PalmDevs/rvp/issues/175)) ([18a66d8](https://github.com/PalmDevs/rvp/commit/18a66d8454cf6e7cfdd4183631a6870c80d16b90))
* `settings` patch ([0e229a4](https://github.com/PalmDevs/rvp/commit/0e229a46cb5b8b74183c47a6eae08d667f941406))
* `settings` patch framework ([#266](https://github.com/PalmDevs/rvp/issues/266)) ([084a99b](https://github.com/PalmDevs/rvp/commit/084a99bc6f5ed67c0b270e219c2dd75a30f302f1))
* `sponsorblock` patch ([#101](https://github.com/PalmDevs/rvp/issues/101)) ([36af4cc](https://github.com/PalmDevs/rvp/commit/36af4cc14ff8057c10b99019cb23acc6e5aec3f2)), closes [#89](https://github.com/PalmDevs/rvp/issues/89) [#90](https://github.com/PalmDevs/rvp/issues/90)
* `spotify-theme` patch ([#608](https://github.com/PalmDevs/rvp/issues/608)) ([7ee1b78](https://github.com/PalmDevs/rvp/commit/7ee1b78e8048698ef6490445dd012e2d88b4d332))
* `swipe-controls` override volume button behaviour ([#285](https://github.com/PalmDevs/rvp/issues/285)) ([69465f3](https://github.com/PalmDevs/rvp/commit/69465f3a9934973a2449605a248a462510e10ff6))
* `swipe-controls` patch ([#115](https://github.com/PalmDevs/rvp/issues/115)) ([1d0a7dc](https://github.com/PalmDevs/rvp/commit/1d0a7dcc0cc3ea2bcd8ce0221d5e2f53d6eb0ae5))
* `swipe-controls` rewrite ([#131](https://github.com/PalmDevs/rvp/issues/131)) ([b7dba09](https://github.com/PalmDevs/rvp/commit/b7dba09927ba15a9eacb06dcb4bf1f268560c96e))
* `tablet-mini-player` patch ([dae41f1](https://github.com/PalmDevs/rvp/commit/dae41f1c59d26d00b1ba821dbe1521e68226f47c))
* `tastebuilder-remover` for music ([a6aeca3](https://github.com/PalmDevs/rvp/commit/a6aeca31bd80b8c4a8acd071e22faca6e136bdb0))
* `tiktok-ads` patch ([#335](https://github.com/PalmDevs/rvp/issues/335)) ([81bef57](https://github.com/PalmDevs/rvp/commit/81bef57742bfaefcdfe02fd290cca6923341149a))
* `tiktok-download` and `tiktok-seekbar` patch ([#405](https://github.com/PalmDevs/rvp/issues/405)) ([f36e000](https://github.com/PalmDevs/rvp/commit/f36e0007c52f4e925a3a2370cdb51bd45ee00a1b))
* `tiktok-feed-filter` , `tiktok-settings` and `tiktok-force-login` patch ([#501](https://github.com/PalmDevs/rvp/issues/501)) ([10e0286](https://github.com/PalmDevs/rvp/commit/10e028626f2b9d9d01279682198daf135bc82c20))
* `tiktok-speed` patch ([#668](https://github.com/PalmDevs/rvp/issues/668)) ([23fff16](https://github.com/PalmDevs/rvp/commit/23fff16e6ab02bf281d46d8b5f93788425d8b525))
* ˋpflotsh-ecmwf-subscription-unlockˋ patch ([#332](https://github.com/PalmDevs/rvp/issues/332)) ([ae2a1d8](https://github.com/PalmDevs/rvp/commit/ae2a1d8362e388032c3521101ff60698c4af1583))
* add "Application Icon Path" option to branding ([1748d1e](https://github.com/PalmDevs/rvp/commit/1748d1e5badf61213d793ff7ae1d090ea2ea82f0))
* add "Application Name" option to branding and move renaming to CustomBrandingPatch.kt ([8dafe05](https://github.com/PalmDevs/rvp/commit/8dafe05b2c5e2b0291d46b02717d910721673712))
* Add (WIP) Signature Checker ([ae4c7b2](https://github.com/PalmDevs/rvp/commit/ae4c7b29f211c461de460f97f3a8656e795adafb))
* add `amoled` patch ([d61bac4](https://github.com/PalmDevs/rvp/commit/d61bac4f8243d0ef72ca91c7c1d5facd858d515e))
* add `custom-video-buffer` patch ([9f117c7](https://github.com/PalmDevs/rvp/commit/9f117c74cdbdcf98eae97cf4c37f0baca451d695))
* add compatibility for YouTube v17.23.36 and v17.24.34 ([1812bc3](https://github.com/PalmDevs/rvp/commit/1812bc39e0e88f1ab02ae8127e9000780eedf49c))
* add debug switch ([#391](https://github.com/PalmDevs/rvp/issues/391)) ([ee4b776](https://github.com/PalmDevs/rvp/commit/ee4b7761d8bb4549f2f100f721c90c664eedfe4a))
* add deprecated & options to patches.json ([759315b](https://github.com/PalmDevs/rvp/commit/759315be1b23a6b3655fc87b56a8974ebac648cc))
* add home ads patch ([36cddd1](https://github.com/PalmDevs/rvp/commit/36cddd1488683e19e2b927e34c80a4f0f3cace35))
* Add JSON meta ([4c229d3](https://github.com/PalmDevs/rvp/commit/4c229d350859903a782c43b13457628739572f09))
* add patches compatibility to the newest version ([799401d](https://github.com/PalmDevs/rvp/commit/799401ddf99da0aaa5f52c39d3d3d4061370fd75))
* add publishing to package registry ([b475e09](https://github.com/PalmDevs/rvp/commit/b475e09577db4dda7bbb45dbf170d78772834a6d))
* add semantic-release ([d60f1d0](https://github.com/PalmDevs/rvp/commit/d60f1d06798d312b158b71691ecc87e828dccbc1))
* add youtube version 17.24.35 ([ec626cc](https://github.com/PalmDevs/rvp/commit/ec626ccfa2bcf14b722d08110382de009a1c12b4))
* add youtube version 17.24.35 ([adc60a6](https://github.com/PalmDevs/rvp/commit/adc60a6fa09f6a21800ba51b8ca888d11a17e870))
* add youtube version 17.25.34 ([#85](https://github.com/PalmDevs/rvp/issues/85)) ([889c9d5](https://github.com/PalmDevs/rvp/commit/889c9d564d16c6e68a52095a4fc8e6d04346c9e9))
* added `codecs-unlock` patch ([e5fd7ce](https://github.com/PalmDevs/rvp/commit/e5fd7cece94b1ff5342178f59b29576db806e0f6))
* **amoled:** remove in favour of `theme` patch ([0032301](https://github.com/PalmDevs/rvp/commit/00323010ed7356a639e4e86916dcbae96a53f7f6))
* **anytracker:** `unlock-premium` patch ([#1076](https://github.com/PalmDevs/rvp/issues/1076)) ([45fb9cd](https://github.com/PalmDevs/rvp/commit/45fb9cdf3a22c567c6d209f630fd83dbd265226a))
* **anytracker:** `unlock-premium` patch ([#1165](https://github.com/PalmDevs/rvp/issues/1165)) ([be46e8c](https://github.com/PalmDevs/rvp/commit/be46e8c0a82aca2580429c4bd27be0ee85f4dd5a))
* **anytracker:** remove `unlock-premium` patch ([#1094](https://github.com/PalmDevs/rvp/issues/1094)) ([af9f547](https://github.com/PalmDevs/rvp/commit/af9f5479b3bb394124601160476ea4bbdf8cbf14))
* **backdrops:** `pro-unlock` patch ([#1121](https://github.com/PalmDevs/rvp/issues/1121)) ([17885f2](https://github.com/PalmDevs/rvp/commit/17885f2f6ddb90b1b0160bb87d4a3854d3820930))
* begin `MicroG Patch` ([91474ba](https://github.com/PalmDevs/rvp/commit/91474ba07376c13e7a71685dfd8b6e6913ed5ee9))
* blacklist `.vsc` folder in `.gitignore` ([#331](https://github.com/PalmDevs/rvp/issues/331)) ([1922253](https://github.com/PalmDevs/rvp/commit/1922253118e670aa66b33186f5cee2ffb3c55718))
* bump compatibility of patches for Youtube to v17.23.35 ([3748d05](https://github.com/PalmDevs/rvp/commit/3748d0533e62a8871ab2202ce9b61170a90dae62))
* bump compatibility of YouTube Music patches to v5.16.51 ([#238](https://github.com/PalmDevs/rvp/issues/238)) ([4fa2a12](https://github.com/PalmDevs/rvp/commit/4fa2a127d715f953a1e4efacaecbc218209a01f3))
* bump music patches to 5.17.51 ([#307](https://github.com/PalmDevs/rvp/issues/307)) ([c303589](https://github.com/PalmDevs/rvp/commit/c303589bd8d1956ce2e3c4c285d45a648b5db30f))
* bump patches compatibility to v17.36.37 ([4493d7e](https://github.com/PalmDevs/rvp/commit/4493d7e6c7d76760cf4bc93968bf425b23c994de))
* bump YouTube Music patches compatibility ([#809](https://github.com/PalmDevs/rvp/issues/809)) ([09f2d8e](https://github.com/PalmDevs/rvp/commit/09f2d8e14937b582bc4bfb7d3a8bb2b7622f772d))
* bump YouTube Music patches compatibility to v5.26.52 ([#681](https://github.com/PalmDevs/rvp/issues/681)) ([f195734](https://github.com/PalmDevs/rvp/commit/f195734925dd41596d058f9cbf2b7e619a8d5833))
* bump YouTube Music patches to v5.21.52 ([#404](https://github.com/PalmDevs/rvp/issues/404)) ([0abb196](https://github.com/PalmDevs/rvp/commit/0abb1960c10f03149e45e9e5074cafcc1801fc32))
* bump YouTube Music patches to v5.22.54 ([#409](https://github.com/PalmDevs/rvp/issues/409)) ([859176e](https://github.com/PalmDevs/rvp/commit/859176e3ece415243ba887424513a961fe4a5ad8))
* bump YouTube Music patches to v5.23.50 ([#462](https://github.com/PalmDevs/rvp/issues/462)) ([15c10b1](https://github.com/PalmDevs/rvp/commit/15c10b1e0368a021b0f2ec46bc2e9ea84a5d5afd))
* bump YouTube Music patches to v5.25.51 ([#669](https://github.com/PalmDevs/rvp/issues/669)) ([563c846](https://github.com/PalmDevs/rvp/commit/563c8466568d578de7c8a8e869fb1aa74370784a))
* bump YouTube patches to `v17.32.35` ([#347](https://github.com/PalmDevs/rvp/issues/347)) ([5292a0e](https://github.com/PalmDevs/rvp/commit/5292a0e973953225f94eed887a5d8f1ead17bb97))
* bump YouTube patches to v17.41.37 ([#878](https://github.com/PalmDevs/rvp/issues/878)) ([9072986](https://github.com/PalmDevs/rvp/commit/9072986f99e624386ff51c7eeb1d65158bd9249a))
* bump youtube version to v17.33.42 ([#398](https://github.com/PalmDevs/rvp/issues/398)) ([769aa25](https://github.com/PalmDevs/rvp/commit/769aa25a6fffbff4c895ae8a291d97836ba03ed9))
* bundle `dex` file into `jar` file ([#359](https://github.com/PalmDevs/rvp/issues/359)) ([f419252](https://github.com/PalmDevs/rvp/commit/f4192526eab1e3e0208e7460847b892e077fcf5a))
* **citra:** `premium-unlock` patch ([#1115](https://github.com/PalmDevs/rvp/issues/1115)) ([df10dfa](https://github.com/PalmDevs/rvp/commit/df10dfae28280da258dc653367e55ac898c04ebc))
* **crunchyroll:** `enable-downloads` patch ([#1119](https://github.com/PalmDevs/rvp/issues/1119)) ([8ec62f8](https://github.com/PalmDevs/rvp/commit/8ec62f8a3151fc9d9b5876e564182501af55d530))
* **custom-playback-speed:** max, min, granularity option ([b1e423d](https://github.com/PalmDevs/rvp/commit/b1e423d9cdca51e54c154cc39a24c508ca322f60))
* **debugging:** simplify patch name and description ([61762f7](https://github.com/PalmDevs/rvp/commit/61762f76c457f348ef599e146f3853e941d4c45c))
* disable sponsorblock on shorts ([#439](https://github.com/PalmDevs/rvp/issues/439)) ([47fbcba](https://github.com/PalmDevs/rvp/commit/47fbcba3f845b5c3ef35c4dded8d6f9ffafc5d9e))
* display metadata for each signature in `SignatureChecker` ([736a71f](https://github.com/PalmDevs/rvp/commit/736a71fac21a32dbb1eef9c3a9f0d3005e7d9ca0))
* **downloads:** missing package installation request ([bc9e81a](https://github.com/PalmDevs/rvp/commit/bc9e81a6c343a912cab6fe3c2560d759fbf1be8a))
* explicit support for YouTube v17.34.35 and v17.34.36 ([#527](https://github.com/PalmDevs/rvp/issues/527)) ([1b6a64b](https://github.com/PalmDevs/rvp/commit/1b6a64b49c54ab53df463981a9ad7ec67729939f))
* generate & upload dex files ([#18](https://github.com/PalmDevs/rvp/issues/18)) ([e6f5355](https://github.com/PalmDevs/rvp/commit/e6f53553a98c164c4eb926fb273358ed506e00a4))
* generate dex files using gradle task ([c34c1be](https://github.com/PalmDevs/rvp/commit/c34c1be21f50b4f720a7cd81e0dfe5ef6330caab))
* get required register dynamically ([0924ca2](https://github.com/PalmDevs/rvp/commit/0924ca2ad30ae865dcc0fd484cb0da517e827352))
* **hexeditor:** `disable-ads` patch ([#973](https://github.com/PalmDevs/rvp/issues/973)) ([a48e5fd](https://github.com/PalmDevs/rvp/commit/a48e5fd50dcf9ee061ffd5c5ed0b997067f40652))
* hide watermark support for 17.25.34 ([#87](https://github.com/PalmDevs/rvp/issues/87)) ([0cdb65b](https://github.com/PalmDevs/rvp/commit/0cdb65bbb3e7b9d75eb393ee87e3718bcd6af4b3))
* **iconpackstudio:** `unlock-pro` patch ([#1047](https://github.com/PalmDevs/rvp/issues/1047)) ([fcbca9c](https://github.com/PalmDevs/rvp/commit/fcbca9cf0ff3940c48df53a9e5e4d06d65f9a1b1))
* implement `wide-searchbar` Patch ([#130](https://github.com/PalmDevs/rvp/issues/130)) ([332f4d1](https://github.com/PalmDevs/rvp/commit/332f4d12d06316d65db252a280fe1f263e65c3a8))
* Initial commit ([bee5f2f](https://github.com/PalmDevs/rvp/commit/bee5f2faed882271ed059b0435e6e1aa91f93dbd))
* integrations patch ([19c0b0d](https://github.com/PalmDevs/rvp/commit/19c0b0d194bb97c7248ea7a9b081176961653b9d))
* issue templates ([b82b0aa](https://github.com/PalmDevs/rvp/commit/b82b0aad88b7ab9d86f1bcc8e007f6a76a9aa1a5))
* make resource mapping patch aware of types ([#77](https://github.com/PalmDevs/rvp/issues/77)) ([188491a](https://github.com/PalmDevs/rvp/commit/188491a707abccc1164413f075d8a66c145a1455))
* migrate to breaking changes of patcher ([d9147cd](https://github.com/PalmDevs/rvp/commit/d9147cd60c0c25d0c5cc05409b8889dfacd89af9))
* migrate to dalvik patches ([e088c67](https://github.com/PalmDevs/rvp/commit/e088c671081bcf75586ccc1c4bdbed9366e93874))
* MinimizedPlayback, CreateButtonRemover ([cc08c6c](https://github.com/PalmDevs/rvp/commit/cc08c6c3d38879dd4672ec671631b34aa2e3cc77))
* **moneymanager:** `unlock-premium` patch ([#1173](https://github.com/PalmDevs/rvp/issues/1173)) ([e0441fc](https://github.com/PalmDevs/rvp/commit/e0441fca79d42d0b0ae654c64b8d597b15c84e9b))
* **music:** bump compatibility to v5.34.51 ([64a8217](https://github.com/PalmDevs/rvp/commit/64a821734dad657dbbbdd42c0461f6468cbe7411))
* **myexpenses:** `unlock-pro` patch ([#1120](https://github.com/PalmDevs/rvp/issues/1120)) ([f4608f7](https://github.com/PalmDevs/rvp/commit/f4608f7c19592e791289f439af8fb52b1cba4dc8))
* **nyx:** `unlock-pro` patch ([#1004](https://github.com/PalmDevs/rvp/issues/1004)) ([9dd8239](https://github.com/PalmDevs/rvp/commit/9dd82391f3f97247224e09e0143b2272a3d47053))
* OldQualityLayout, HideSuggestions, HideReels, EnableSeekbarTapping ([04a7cff](https://github.com/PalmDevs/rvp/commit/04a7cfff20d2734b1c92713de4e7e08a3b93ee85))
* patch requests issue template ([#467](https://github.com/PalmDevs/rvp/issues/467)) ([d8bb354](https://github.com/PalmDevs/rvp/commit/d8bb35472258c0634599102f4f4bf4cea587a817)), closes [revanced/revanced-patches#463](https://github.com/revanced/revanced-patches/issues/463)
* Patches for YouTube Music ([b60c9d3](https://github.com/PalmDevs/rvp/commit/b60c9d33b611bb4d5b55bb419652bc14b0309792))
* remove `force-vp9-codec` patch ([#287](https://github.com/PalmDevs/rvp/issues/287)) ([e428978](https://github.com/PalmDevs/rvp/commit/e42897801b20e7439969954753e2c15c85eb41b5))
* remove compatibility for YouTube  v17.41.37 ([#886](https://github.com/PalmDevs/rvp/issues/886)) ([0f4bc19](https://github.com/PalmDevs/rvp/commit/0f4bc197455574b84dd1cb1a43f03af90858bc39))
* remove obsolete patch `Hide suggestions patch` ([e65c6f2](https://github.com/PalmDevs/rvp/commit/e65c6f240ed23a54271d20a90fc57ec65cafc02d))
* remove partially complete patch ([d212e19](https://github.com/PalmDevs/rvp/commit/d212e19c3276c2ba6550f03dfd9bba47b7773524))
* section `acknowledgements` for issue templates ([f663935](https://github.com/PalmDevs/rvp/commit/f663935382036cfdccf04627ca77306c5f951b4c))
* set the correct theme of the settings screen ([70d850c](https://github.com/PalmDevs/rvp/commit/70d850cf295d306b0de9419efe6a4bbf3857d3a0))
* setting for downloader package name ([965d05c](https://github.com/PalmDevs/rvp/commit/965d05cfa55d7a51f64a11f0219e2867568ba852))
* **sleepasandroid:** `unlock-premium` patch ([#1172](https://github.com/PalmDevs/rvp/issues/1172)) ([14a33ee](https://github.com/PalmDevs/rvp/commit/14a33eead020839add7a258a5d1b1c2590a60307))
* sort README patch table by amount of patches per package ([adf96f6](https://github.com/PalmDevs/rvp/commit/adf96f623a2207e2e562d5382b06afc245565206))
* **sponsorblock:** string for response error code 400 ([#512](https://github.com/PalmDevs/rvp/issues/512)) ([d42569f](https://github.com/PalmDevs/rvp/commit/d42569fcc4367fa65c5c88ddc75098d4e208f7f3))
* Theme Patch ([#440](https://github.com/PalmDevs/rvp/issues/440)) ([f3b92ca](https://github.com/PalmDevs/rvp/commit/f3b92cab5a057ce605b6d9e75e3b99161bf1422c))
* **theme:** arbitrary background color for dark theme ([afd5502](https://github.com/PalmDevs/rvp/commit/afd5502afdb207d5f52516653869b26fae7e5d21))
* **theme:** arbitrary background color for light theme  ([#565](https://github.com/PalmDevs/rvp/issues/565)) ([da40e7e](https://github.com/PalmDevs/rvp/commit/da40e7e0cf266edc89353e62b9821b450f8f0295))
* **ticktick:** `unlock-themes` patch ([#1028](https://github.com/PalmDevs/rvp/issues/1028)) ([7f1fedc](https://github.com/PalmDevs/rvp/commit/7f1fedcddd4330a5f884b813a20f2f8e84e2c9da))
* **tiktok-download:** custom download path ([#479](https://github.com/PalmDevs/rvp/issues/479)) ([944aa48](https://github.com/PalmDevs/rvp/commit/944aa485cec513faa30a21b91887dcacf9d70b45))
* **tiktok:** `sim-spoof` patch ([#1088](https://github.com/PalmDevs/rvp/issues/1088)) ([e9e6683](https://github.com/PalmDevs/rvp/commit/e9e66834c525317962627536b4205528ef6418d4))
* **tiktok:** `tiktok-web-login` patch ([#593](https://github.com/PalmDevs/rvp/issues/593)) ([aae67ce](https://github.com/PalmDevs/rvp/commit/aae67cee133e86ed9868977d5734ff104e1118b9))
* **tiktok:** adapt `tiktok-download` with `tiktok-settings`. ([#586](https://github.com/PalmDevs/rvp/issues/586)) ([876b726](https://github.com/PalmDevs/rvp/commit/876b7266109b099597dd19d6ed3fa3dac098b73b))
* **twitch/block-embedded-ads:** `block-embedded-ads` patch support ([#1160](https://github.com/PalmDevs/rvp/issues/1160)) ([75fba85](https://github.com/PalmDevs/rvp/commit/75fba85ddf38c0d87a635748f22a92c51747d166))
* **twitch/show-deleted-messages:** `show-deleted-messages` patch ([#1030](https://github.com/PalmDevs/rvp/issues/1030)) ([7e6b453](https://github.com/PalmDevs/rvp/commit/7e6b4534013a03ddc7eb11a1f911fa0564372118))
* **twitch:** `block-audio-ads` patch ([#1041](https://github.com/PalmDevs/rvp/issues/1041)) ([3419bae](https://github.com/PalmDevs/rvp/commit/3419baed489ce231f84b3e2d600cf123cdfa7ff7))
* **twitch:** `block-video-ads` patch  ([#1040](https://github.com/PalmDevs/rvp/issues/1040)) ([b47bf24](https://github.com/PalmDevs/rvp/commit/b47bf24d1b52cfa1883a942894a6216ae81b8325))
* **twitch:** `debug-mode` patch ([#1031](https://github.com/PalmDevs/rvp/issues/1031)) ([c514860](https://github.com/PalmDevs/rvp/commit/c514860bc4a46295b11f09df9ffc1c556b798eb3))
* **twitch:** `settings` patch ([#1075](https://github.com/PalmDevs/rvp/issues/1075)) ([6825f1b](https://github.com/PalmDevs/rvp/commit/6825f1b8e0cfb71e78e59e85158bf872661b1432))
* **twitch:** ˋintegrationsˋ  dependency patch ([#1074](https://github.com/PalmDevs/rvp/issues/1074)) ([9d59ab5](https://github.com/PalmDevs/rvp/commit/9d59ab582d08a67f869e43d2907024a822af2edf))
* **twitch:** remove `block-embedded-ads` patch ([#1164](https://github.com/PalmDevs/rvp/issues/1164)) ([b77f2b5](https://github.com/PalmDevs/rvp/commit/b77f2b5b387c6d655eb138484725a76d2595f1b1))
* **twitch:** settings for patches ([#1142](https://github.com/PalmDevs/rvp/issues/1142)) ([1fad125](https://github.com/PalmDevs/rvp/commit/1fad1258dcabc74cae27e40f671349fbd0246c4a))
* twitter `timeline-ads` patch ([#222](https://github.com/PalmDevs/rvp/issues/222)) ([f16e67f](https://github.com/PalmDevs/rvp/commit/f16e67fc75c9c3505ff875a216ce7e868022075e))
* update MicroG patch to latest version ([c24f806](https://github.com/PalmDevs/rvp/commit/c24f8063a04f89aea2d2f7087a435738de7dfeae))
* update patches to latest version ([bad25de](https://github.com/PalmDevs/rvp/commit/bad25dec1d73137f8b7a1bf4daaceb2279b4d48c))
* updated all patches to support v17.22.36 of `com.android.google.youtube` ([e12dc11](https://github.com/PalmDevs/rvp/commit/e12dc11b670c2b0c414741616e0a646e8421e418))
* use `install` mode by default ([c2b2993](https://github.com/PalmDevs/rvp/commit/c2b299336a984d66a2d066e5ebe9c4f9bee5c2aa))
* use supplier instead of KClass ([08af6e5](https://github.com/PalmDevs/rvp/commit/08af6e54af79ef9ef4fb3372a348ce9b6fba4d20))
* use supplier instead of KClass ([91aa019](https://github.com/PalmDevs/rvp/commit/91aa019f8d3d87fbf7affeb7abc2b02ba87af5c3))
* v17.29.34 compatibility for `downloads` patch ([#374](https://github.com/PalmDevs/rvp/issues/374)) ([d81f1af](https://github.com/PalmDevs/rvp/commit/d81f1af327e0d7471f410811af46da34ddfb1bb4))
* **windyapp:** `unlock-pro` patch ([#1118](https://github.com/PalmDevs/rvp/issues/1118)) ([191ea63](https://github.com/PalmDevs/rvp/commit/191ea634e53717f308be6c999dc15f7dee1f40b9))
* **youtube-music:** bump patches compatibility to v5.31.50 ([#962](https://github.com/PalmDevs/rvp/issues/962)) ([476fcc8](https://github.com/PalmDevs/rvp/commit/476fcc87ca0d33cfbf251e4307755f02ed8f8baa))
* **youtube/comments:** hide shorts comments button ([#866](https://github.com/PalmDevs/rvp/issues/866)) ([c78a74e](https://github.com/PalmDevs/rvp/commit/c78a74e21b4521034f44e9bfd226c5a362c21e6c))
* **youtube/debugging:** include by default & add option to debug on Android ([9d6d5b2](https://github.com/PalmDevs/rvp/commit/9d6d5b29227980aacb4c1331161afb3fa265bbe4))
* **youtube/debugging:** print stack traces ([ddc6c98](https://github.com/PalmDevs/rvp/commit/ddc6c98c4c2d6aa82b746c72edf5347449b038ac))
* **youtube/debugging:** use more suitable preference title ([d182351](https://github.com/PalmDevs/rvp/commit/d182351e789bcbfb7982774406449e8d973765b2))
* **youtube/enable-wide-searchbar:** bump compatibility to v17.45.36 ([6687dce](https://github.com/PalmDevs/rvp/commit/6687dce21e6e2b5ddc7bd6bf631ccc6253df70aa))
* **youtube/general-ads:** check for ad in identifier ([fd0506e](https://github.com/PalmDevs/rvp/commit/fd0506eb95dbf398eb7d6bfa8732f517b9867545))
* **youtube/general-ads:** custom component filter ([be562fb](https://github.com/PalmDevs/rvp/commit/be562fb2dbf5585d3087bc69b828705f9859baea))
* **youtube/general-ads:** do not hide community posts by default ([6269638](https://github.com/PalmDevs/rvp/commit/626963819c183cbfeca4ff4ab0a16fc39ed9d8a8))
* **youtube/general-ads:** hide chapter teaser under videos ([9cf415a](https://github.com/PalmDevs/rvp/commit/9cf415a894ab5458134ef1cd5a4c5bf7579e592c))
* **youtube/general-ads:** hide gray separators ([18a9008](https://github.com/PalmDevs/rvp/commit/18a900839b2f8bc85db6ce7e6753213f274e2031))
* **youtube/general-ads:** hide self sponsored cards ([b627d75](https://github.com/PalmDevs/rvp/commit/b627d751b49c228e52f7f9fb5d2bcacb9d243a64))
* **youtube/general-ads:** hide shorts in search ([c01ba5c](https://github.com/PalmDevs/rvp/commit/c01ba5cbcc694f8c9ee83a4e9eb081cf5b45753c))
* **youtube/general-ads:** normalize switch names ([569763a](https://github.com/PalmDevs/rvp/commit/569763a09bddadd50434314dc77588d562697b42))
* **youtube/hdr-auto-brightness:** increase strength of fingerprint ([2379b58](https://github.com/PalmDevs/rvp/commit/2379b5892b3505c8780f475bbc56f520613fa31d))
* **youtube/hide-create-button:** bump compatibility to v17.45.36 ([b3986ab](https://github.com/PalmDevs/rvp/commit/b3986abf172f696a56cd5e928e72ce1826f142f8))
* **youtube/hide-mix-playlists:** hide in video suggestions ([#854](https://github.com/PalmDevs/rvp/issues/854)) ([acde5f0](https://github.com/PalmDevs/rvp/commit/acde5f066053ca3d58ca09fc2a6a1381ba27d84b))
* **youtube/hide-shorts-button:** bump compatibility to v17.45.36 ([04fd8b7](https://github.com/PalmDevs/rvp/commit/04fd8b7b2f9f3cd242fec63807fa6403b3330a20))
* **youtube/microg-support:** handle availability of Vanced MicroG ([bfd0d14](https://github.com/PalmDevs/rvp/commit/bfd0d1418fb68f1d37687ec2072d3b64a9c3c6ee))
* **youtube/remember-video-quality:** remember current quality option ([9c510d4](https://github.com/PalmDevs/rvp/commit/9c510d472048f5bce127eb0329e53aaf259e9b1b))
* **youtube/remember-video-quality:** remember the quality until changed by default ([1aebabe](https://github.com/PalmDevs/rvp/commit/1aebabefdb0b163e0020fd3b52d7d1fa2404764b))
* **youtube/return-youtube-dislike:** compatibility for old and new button layout ([6629bd7](https://github.com/PalmDevs/rvp/commit/6629bd71716a753be06617724e536b8ab4c3b69a))
* **youtube/return-youtube-dislike:** improve settings labels ([#1203](https://github.com/PalmDevs/rvp/issues/1203)) ([4e10d9f](https://github.com/PalmDevs/rvp/commit/4e10d9f577ca9f5eef24c5650219d6e911fd07cc))
* **youtube/return-youtube-dislike:** show dislike as a percentage ([#1185](https://github.com/PalmDevs/rvp/issues/1185)) ([808ca82](https://github.com/PalmDevs/rvp/commit/808ca8288d64c6042c7e86a687463a3c7ad6b6ff))
* **youtube/return-youtube-dislike:** simplify preference descriptions ([#1216](https://github.com/PalmDevs/rvp/issues/1216)) ([cf352e6](https://github.com/PalmDevs/rvp/commit/cf352e65f98c9c26593e5f1383ec2529fcf7877b))
* **youtube/sponsorblock:** skip segments once automatically ([#907](https://github.com/PalmDevs/rvp/issues/907)) ([afc7588](https://github.com/PalmDevs/rvp/commit/afc75882062a9316dbc28a9dc4f990cf88b52654))
* **youtube/theme:** exclude the patch by default ([d3ceecf](https://github.com/PalmDevs/rvp/commit/d3ceecfd0d91b70285850c9d3e6b5c92ed461153))
* **youtube/theme:** extend theming to splash screen ([#769](https://github.com/PalmDevs/rvp/issues/769)) ([f7bb937](https://github.com/PalmDevs/rvp/commit/f7bb937ef2374d1042ea3772f03627d7f0111b78))
* **youtube/theme:** make amoled the default color for dark theme background" ([f0c7e14](https://github.com/PalmDevs/rvp/commit/f0c7e142d417395fe4b1481fac41e589b00b4bd1))
* **youtube/theme:** make dark the default color for dark theme background ([17bb066](https://github.com/PalmDevs/rvp/commit/17bb066ed09547e95c63f06b6d5717e25657a57a))
* **youtube:** `disable-zoom-haptics` patch ([#1079](https://github.com/PalmDevs/rvp/issues/1079)) ([b5eaf7a](https://github.com/PalmDevs/rvp/commit/b5eaf7ab2450d60ba8bcd189da63c47b85a9660e))
* **youtube:** `hide-captions-button` patch ([#770](https://github.com/PalmDevs/rvp/issues/770)) ([478af6a](https://github.com/PalmDevs/rvp/commit/478af6ad54ffdf6f99abab35a84a4f50b59d28c8))
* **youtube:** `hide-mix-playlists` patch  ([#816](https://github.com/PalmDevs/rvp/issues/816)) ([e76c73b](https://github.com/PalmDevs/rvp/commit/e76c73b455c65aa605e418f19d88b64e0e244901))
* **youtube:** `open-links-directly` patch ([#999](https://github.com/PalmDevs/rvp/issues/999)) ([bf85f62](https://github.com/PalmDevs/rvp/commit/bf85f62f30242f91bdaf53b44ae6a9a2b3b6e1b4))
* **youtube:** `remove-player-button-background` patch ([#855](https://github.com/PalmDevs/rvp/issues/855)) ([c997a2d](https://github.com/PalmDevs/rvp/commit/c997a2d9a54ce92d5a76aaee9aaa01a4e5c1c722))
* **youtube:** bump patches compatibility to v17.41.37 ([#888](https://github.com/PalmDevs/rvp/issues/888)) ([11ed0c0](https://github.com/PalmDevs/rvp/commit/11ed0c0fb3236d87284806d2fa957699e908cc61))
* **youtube:** bump patches compatibility to v17.43.36 ([#924](https://github.com/PalmDevs/rvp/issues/924)) ([3867514](https://github.com/PalmDevs/rvp/commit/38675144dcb616474a047bcf8f7e1bf1f668ea46))
* **youtube:** bump patches compatibility to v17.45.36 ([1e10dd7](https://github.com/PalmDevs/rvp/commit/1e10dd76040ae40e2d27b9335458979330f31578))
* **youtube:** drop support for compatibility of old versions ([140ac10](https://github.com/PalmDevs/rvp/commit/140ac10fd0021fb48b7682953808b9d17c768130))


### Performance Improvements

* fix high battery consumption due to chromecast not working with `microg` ([dd8b01a](https://github.com/PalmDevs/rvp/commit/dd8b01a5c5d75b00ea4d04ce35bc43942c1b0409))
* **general-ads:** hook pathBuilder ([b9bad0b](https://github.com/PalmDevs/rvp/commit/b9bad0bb922bbd44ddf2acbfae87243beb28851a))
* **resource-mapping:** map resources with multiple threads ([a7e4da0](https://github.com/PalmDevs/rvp/commit/a7e4da018bf939accdf6d406b471ac74f9078095))


### Reverts

* Revert "Changed app name to ReVanced (#21)" (#24) ([70a48c5](https://github.com/PalmDevs/rvp/commit/70a48c5f35cd236612352a1dbbf50487625e6e96)), closes [#21](https://github.com/PalmDevs/rvp/issues/21) [#24](https://github.com/PalmDevs/rvp/issues/24)
